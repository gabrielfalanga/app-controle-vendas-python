...
class BannerVenda(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        # atualiza o retângulo quando o canvas mudar de tamanho/posição
        ...
        direita_label_data = Label(text=f'Data: {data}',
                                   size_hint=(1, 0.33), pos_hint={'right': 1, 'top': 0.9})
        direita_label_preco = Label(text=f'Preço: R${preco:,.2f}',
                                    size_hint=(1, 0.33), pos_hint={'right': 1, 'top': 0.65})
        direita_label_quantidade = Label(text=f'{quantidade} {unidade}',
                                         size_hint=(1, 0.33), pos_hint={'right': 1, 'top': 0.4})
